...
Create a variable named "MOBILE_GEOLOCATION_API_ROOT" pointing to a working copy of the http://gwt-mobile-webkit.googlecode.com/svn/trunk/geolocation folder.
