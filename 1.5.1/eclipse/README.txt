...
Create a variable named "MOBILE_DATABASE_API_ROOT" pointing to a working copy of the http://gwt-mobile-webkit.googlecode.com/svn/trunk/gwt-mobile-webkit/database folder.
